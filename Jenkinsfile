pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/godbolnt'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Noah-G737/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('godbolnt-225')                                                         //<------change this
    }
